...
<div class="container-fluid">
    ...
    <div class="row mb-1">
        ...
        <div class="col-md-3">
            <label for="centerto">To Center</label>
            <select name="centerto" id="centerto" class="form-select form-select-sm">
...
<script type="module" src="<?php echo URLROOT;?>/dist/js/pages/reports/stocks/transfersReport.js"></script>                   
