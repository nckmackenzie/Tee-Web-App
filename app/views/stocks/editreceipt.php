...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">
                    <a href="<?php echo URLROOT;?>/stocks/receipts" class="btn btn-warning btn-sm ms-1">&larr; Back</a>
                </h4>
            </div>
        </div>
    </div>     
    ...
    <div class="row">
        ...
        <?php if(intval($data['qty_err']) > 0) : ?>
            ...
            <?php endif ;?>
        <div class="col-12">
            <form action="<?php echo URLROOT;?>/stocks/createupdatereceipt" autocomplete="off" method="post" name="receiptform">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="mb-1">
                                    ...
                                    <input type="text" name="reference" id="reference" 
                                           ...
                                           value="<?php echo $data['reference'];?>" readonly>
                                </div>
                            </div>
                            <?php if($data['type'] === 'internal') : ?>
                                <div class="col-md-4">
                                    <div class="mb-1">
                                        <label for="mtn" class="form-label">MTN No</label>
                                        <input type="text" name="mtn" id="mtn" 
                                            class="form-control form-control-sm mandatory" 
                                            value="<?php echo $data['mtn'];?>" readonly>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div><!-- /.row -->
