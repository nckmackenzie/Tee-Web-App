...
import { submitHandler } from './formSubmit-v1.js';
//prettier ignore
import {
  HOST_URL,
  displayAlert,
...
addBtn.addEventListener('click', () => {
  const sofyCopyChkbx = document.getElementById('softcopy');
  if (!qtyInput.value) {
  ...
  let html = `
      <tr>
        ...
        <td class="d-none"><input type="text" class="table-input softcopy" name="softcopies[]" value="${
          sofyCopyChkbx.checked
        }" readonly></td>
